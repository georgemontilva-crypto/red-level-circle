  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-4">
        <SectionBanner sectionKey="shop" height="h-44 sm:h-56">
          <div>
            <div className="flex items-center gap-2 mb-2">
              <ShoppingBag className="w-5 h-5 text-red-500" />
              <span className="text-red-400 font-mono text-xs tracking-widest uppercase">Tienda RLC</span>
            </div>
            ...
            <p className="text-zinc-300 text-sm max-w-md mb-3">Canjea tus RLC Coins por productos exclusivos. Físicos y digitales.</p>
            {isAuthenticated && me && (
