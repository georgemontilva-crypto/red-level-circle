  ...
  tournaments: router({
    ...
    create: toProcedure
      .input(z.object({
        ...
        bracketType: z.enum(["single_elimination", "double_elimination", "groups", "swiss", "round_robin"]),
    ...
    update: premiumProcedure
      .input(z.object({
        ...
        description: z.string().optional(),
        rules: z.string().optional(),
        bracketType: z.enum(["single_elimination", "double_elimination", "groups", "swiss", "round_robin"]).optional(),
